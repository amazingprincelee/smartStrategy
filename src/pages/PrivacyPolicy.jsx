        ...
        <div className="space-y-8 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-300">
              <li><span className="text-white font-medium">Account data:</span> Email address, full name, and password (hashed — never stored in plain text).</li>
              <li><span className="text-white font-medium">Google OAuth data:</span> If you sign in with Google, we receive your name and email from Google. We do not receive your Google password.</li>
              <li><span className="text-white font-medium">Exchange API keys:</span> If you connect an exchange account for bot trading, your API keys are stored encrypted. We only use them to place trades on your behalf.</li>
              <li><span className="text-white font-medium">Usage data:</span> Pages visited, signals viewed, bot activity logs. Used to improve the Service.</li>
              <li><span className="text-white font-medium">Payment data:</span> Crypto payment transaction IDs and amounts. We do not store credit card numbers — payments are processed by third-party crypto payment providers.</li>
              <li><span className="text-white font-medium">Referral data:</span> If you were referred by another user or shared a referral link, we track referral codes to credit rewards.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">We do <span className="text-white font-medium">not</span> sell your personal data to third parties.</p>
          </section>
